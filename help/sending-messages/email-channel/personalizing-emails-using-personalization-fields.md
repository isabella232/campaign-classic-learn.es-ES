...
Los campos de personalización se utilizan para la personalización de primer nivel del contenido de los mensajes enviados. Los campos que se insertan en un contenido principal muestran la posición en la que se insertan los datos de un origen de datos seleccionado.
